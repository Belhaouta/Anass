...
<div class="auth">
    <h1> Inscription</h1>
    <hr id="ligne">
    <h3> Bienvenue sur Safarcom. Cr�ez votre compte passager et r�server votre premi�re course en quelques minutes.</h3>
    <form action="" method="POST">
        <input  id="boite1" type="text" name="nom" placeholder="Nom" required />
        <input  id="boite1" type="text" name="prenom" placeholder="Pr�nom" required />
        ...
        <input  id="boite1" type="text" name="tele" placeholder="T�l�phone" required />
        ...
        <input id="button2" type="submit" name="ENVOYER" value="Cr�er un compte"/>
    ...
    <hr id="ligne">
    Vous avez d�j� un compte ? <?php if($_GET["type"]=="TP"){echo '<a href="connexion.php?type=TP">';}
