...
<div class="reservation">
    ...
    <h1> Commencer votre r�servation d�s maintenant </h1>

    <div class="reservation1">
        <form action="" method="POST">
            <input type="button" id="sub" class="typedep" onClick="AfficherMasquer1()" value="D�placement vers l'aeroport" style="background:none;border:none"/>

            <input type="button" id="sub1" class="typedep" onClick="AfficherMasquer()" value="D�placement dans la ville" />
            ...
            <div id="depville" style="display:none">
                ...
                <label>A: </label><input type="text" name="arrive" id="box1"  disabled="true" placeholder="Lieu d'arriv�" required /><br><br>
            </div>


            <label> Date de d�part</label><input type="text" name="date" id="datepicker" placeholder="dd/mm/yy" required />
