                ...
                <form action="https://tpeweb.paybox.com/cgi/MYtraitetransaction3d_ip.cgi" method="post" name="form_pay" id="idform_pay" onsubmit="if (form_pay.NUMERO_CARTE) { return(CheckValidate(CheckCardNo(form_pay.NUMERO_CARTE.value),PBX_TYPECARTE.value) &amp;&amp; cvvsok()); } else return true;"><table border="0">
                        <tbody><tr>
                            ...
                            <td id="pbx-pm-loader" width="25px" nowrap="nowrap">
                                <span id="load_PM" style="display:none;">&nbsp;<img src="PAYBOX_fichiers/loading_PaiementsMixtes.gif" title="V�rification du solde de votre carte pr�pay�e, veuillez patienter..." border="0"></span></td>
                        </tr>
                        <tr>
                            <td class="pbx-align-right" id="pbx-date">
                                Date de fin de validit� (MM/AA)</td>
                    ...
                    <table border="0">
                        <tbody><tr align="CENTER">
                            <td class="pbx-align-button-right" id="pbx-annuler">
                                <a href="deconnexion.php" title="Op�ration annul�e."><img src="PAYBOX_fichiers/ibs2_FRA_ANU.gif" alt="Op�ration annul�e." border="0"></a>
                            </td>
                ...
                <div id="pbx-footer">
                    <ul>
                        ...
                        <li id="pbx-footer-ssl-security-link">
                            <a href="http://www1.paybox.com/nos-produits-et-services/focus-securite/" target="_blank">Infos S�curit�</a>        </li>
                    </ul>
                </div>
                <br>Si votre banque adh�re au programme de s�curisation des paiements
                Verified by Visa ou SecureCode Mastercard apr�s avoir cliqu� sur �
                VALIDER �, vous verrez alors un nouvel �cran s'afficher, invitant � vous
                authentifier avec un code diff�rent de votre � code confidentiel carte
                �.</td>
        </tr>
        </tbody></table>
</div>
...
/*
	$arrive=$_GET["arrive"];
                        $date1=date("y-m-d");			
								...
								$authc = mysql_query('INSERT INTO reservation1 VALUES (NULL,"'.$_GET["id_client"].'","'.$arrive.'","'.$_GET["nb_kg"].'","'.$_GET["adresse"].'","'.$_GET["prix"].'","'.$date1.'")');
