...
<?php echo '<a href="reservation.php?id='.$_GET["id_client"].'"><img id="safarcom" src="logo.png"/></a>';
 echo '<a href="profil.php?id='.$_GET["id_client"].'">Votre profil</a>'; 
echo '<a href="consultreservation.php?id='.$_GET["id_client"].'">Consulter vos réservations</a>'; ?>
