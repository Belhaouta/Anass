...
divInfo2 = document.getElementById('ab');
divInfo3 = document.getElementById('ab1');
...
document.getElementById('datepickerTM').disabled= true;
document.getElementById('datepickerTM1').disabled= false;
...
document.getElementById('datepickerTM1').disabled= true;
document.getElementById('datepickerTM').disabled= false;
...
<input type="button" id="sub" class="typedepTM" onClick="AfficherMasquer1()" value="Type1" style="background:none;border:none"/>

<input type="button" id="sub1" class="typedepTM" onClick="AfficherMasquer()" value="Type2" />
...
<div id="ab1">
<input id="datepickerTM" name="nb" placeholder="Poids" type="number" max="3500" min="1" required /><br><br>
</div>
<div id="ab" style="display:none">
<input id="datepickerTM1" name="nb" placeholder="Poids" type="number" disabled="true"  min="3500" required /><br><br>
</div>
