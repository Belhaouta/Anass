...
<?php echo '<a href="accueilTM.php?id='.$_GET["id_client"].'"><img id="safarcom" src="logo.png"/></a>';
 echo '<a href="profilTM.php?id='.$_GET["id_client"].'">Votre profil</a>'; 
echo '<a href="consultreservationTM.php?id='.$_GET["id_client"].'">Consulter vos réservations</a>'; ?>
